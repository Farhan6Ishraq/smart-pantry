...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: '#5D1C6A' }}>
      <div className="rounded-lg shadow-2xl p-8 w-full max-w-md" style={{ backgroundColor: '#FFF1D3' }}>
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold" style={{ color: '#5D1C6A' }}>Create Account</h1>
          <p className="mt-2" style={{ color: '#CA5995' }}>Join us today</p>
        </div>
        ...
        <div className="mt-8 pt-6" style={{ borderTop: '1px solid #CA5995' }}>
          <p className="text-center" style={{ color: '#5D1C6A' }}>
            ...
            <Link href="/login" className="font-semibold hover:underline transition-colors" style={{ color: '#CA5995' }}>
              Login here
            </Link>
          </p>
        </div>
